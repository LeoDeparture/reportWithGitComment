...
event = {  # 测试用的JSON
  ...
  "resources": [
    "arn:aws-cn:ecs:cn-northwest-1:412934042350:service/mis-website-service-dev-fargate"
  ],
  "detail": {
    "eventType": "INFO",
    "eventName": "SERVICE_STEADY_STATE",
    "clusterArn": "arn:aws-cn:ecs:cn-northwest-1:412934042350:cluster/zhiwen-cluster-dev",
